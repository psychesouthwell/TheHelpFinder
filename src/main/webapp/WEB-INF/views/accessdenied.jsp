			...
			<div class="container">
				<div class="std">
					<div class="page-not-found">
						<h1>ACCESS DENIED</h1>
						<h3>Oops! You're not authorized to access this page</h3>
						<div>
							<a href="home" class="btn-home"><span>Back To Home</span></a>
						</div>
						<br>
						<br>
						<c:choose>
							<c:when test="${empty loggedInuser}">
								<div>
									<a href="login" class="btn-home"><span>Log In</span></a>
								</div>
								<br>
								<br>
								<div>
									<a href="register" class="btn-home"><span>Register</span></a>
								</div>
								<br>
								<br>
							</c:when>
							<c:otherwise>
								<div>
									<a href="profile" class="btn-home"><span>Profile</span></a>
								</div>
								<br>
								<br>
								<div>
									<a href="logout" class="btn-home"><span>Log Out</span></a>
								</div>
							</c:otherwise>
						</c:choose>
					</div>
